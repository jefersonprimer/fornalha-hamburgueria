    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-20">
      <div className="bg-white p-6 rounded-md w-[500px] max-w-[90%]" style={{ zIndex: 9999 }}>
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={onClose} className=" text-gray-500 text-2xl bg-[#E5E7EB] rounded-[50%] hover:bg-[#FFFFFF]">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-4">
          ...
          <div className="text-sm text-black">
            ...
            <p className="mt-4">
              ...
              <a href="https://www.instagram.com/hamburgueria_fornalha_fw/" className="text-blue-500">
                @hamburgueria_fornalha_fw
              </a>
            </p>
          </div>
        </div>
        ...
        <div className="text-sm text-black mt-4 text-center sm:text-left">
          <div>
            ...
            <div className="flex flex-wrap">
              <a
                href="https://web.whatsapp.com/send?phone=55996869185"
                target="_blank"
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" height="512" viewBox="0 0 24 24" width="512" className="w-5 h-5 fill-current">
                ...
                <span className="text-sm whitespace-nowrap h:bg-[#374151]">(55) 99686-9185</span>
              </a>

              <a
                href="tel:(55) 37441604"
                rel="nofollow"
              ...
              >
                ...
                <span className="text-sm whitespace-nowrap">(55) 3744-1604</span>
              </a>
            </div>
          </div>
          <div className="mt-4">
...
const HeaderWithStatus: React.FC = () => {
  ...
  // Use useLayoutEffect to ensure it runs only on the client-side
  useLayoutEffect(() => {
