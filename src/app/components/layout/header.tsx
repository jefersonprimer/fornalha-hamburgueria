    ...
    <header className="relative flex items-center justify-between p-2 px-6 bg-[#171312] shadow-md">
      ...
      <div className="relative">
        <input
          ...
          className="pl-8 pr-10 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-[#F80305] text-black sm:block hidden"
        />
      ...
      >
        ...
        <path
          fill="currentColor"  // Usando a cor do texto
          fillRule="evenodd"
          clipRule="evenodd"
      ...
      <nav className="flex gap-4">
        ...
        >
          <Link href="/login">
            <span className="text-white hover:text-[#F80305] sm:block hidden">Entre ou Cadastre-se</span>
          </Link>
          <svg
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex justify-center items-center">
          <div className="bg-white p-4 rounded-lg w-64">
            <nav className="flex flex-col gap-4">
              ...
              <a
                href="#"
                onMouseEnter={() => setIsHoursModalVisible(true)}
                onMouseLeave={() => setIsHoursModalVisible(false)}
                className="text-black hover:text-[#F80305]"
              >
                Horários
              </a>
            </nav>
